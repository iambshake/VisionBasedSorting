...
def init_angles():
	...
	initial = [0, -15, -75, 0, 90, 0, 60, 1]
	with open('/home/jetson/Desktop/Abhishek/codes/joint_angles.txt', 'w') as f:
...
# if open_port():
#     enable_torque(True)
#     set_profile_velocity(100)  # 10
#     set_profile_acceleration(40)  # 8

try:
    while True:
        with open('/home/jetson/Desktop/Abhishek/codes/joint_angles.txt', 'r') as f:
            lines = f.readlines()
        if not lines:
            continue
